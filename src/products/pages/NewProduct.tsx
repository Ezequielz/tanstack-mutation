...
export const NewProduct = () => {
  ...
  const { control, handleSubmit, watch } = useForm<FormInputs>({
    defaultValues: {
      title: 'teclado',
      price: 150.22,
      description: 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Suscipit, adipisci? Incidunt quo aliquid, laboriosam pariatur deserunt, fugit iusto veniam minima assumenda dolore qui nesciunt? Esse!',
